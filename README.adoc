...
image:https://img.shields.io/badge/license-MIT%20%2B%20Palimpsest%20v0.8-blue.svg[License: MIT + Palimpsest,link=LICENSE]
...
. *MIT License* - Maximum compatibility and permissive use
